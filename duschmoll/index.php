...
<body>
    <div class="main">
        ...
        <section id="article">
            ...
            <h2>First Post</h2>
            <h5>30 April, 2021</h5>
            <img src="res/img/newspaper.jpg" alt="Image of newspaper" class="image">
            <p>This is the first mock-up of my website, I needed to test an article to progress forward.</p>
